 ...
 */
package D3981791.phase_2.Controller;

import D3981791.phase_2.Library.ActivityAddOnRepository;
import D3981791.phase_2.Library.ActivityRepository;
import D3981791.phase_2.Library.ItineraryAddonRepository;
import D3981791.phase_2.Model.*;
import D3981791.phase_2.View.ConsoleUI;
...
public class Phase2Run {
  ...
  public static void main(String[] args) {
    ...
    for (int i = 0; i < totalActivities; i++) {
      ...
      availableActivities.remove(activityNumber - 1);
    ...
    display.printItinerary(itinerary);
