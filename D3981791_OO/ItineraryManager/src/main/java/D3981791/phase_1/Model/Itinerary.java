...
public class Itinerary {
  ...
  public Itinerary(int totalAttendees, int totalActivities, String leadAttendeeFirstName, String leadAttendeeLastName, LocalDate date) {
  ...
  public void calculateTotalItineraryAddOnsCost() {
    ...
    this.totalItineraryAddOnsCost = cost;
  }
